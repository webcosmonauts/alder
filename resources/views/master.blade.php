    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            <div class="sidebar-brand-icon">
                <object type="image/svg+xml" data="/svgs/alder.svg" style="max-width: 50px; max-height: 50px">
        ...
        @foreach($admin_menu_items as $section)
            ...
            @foreach($section->children as $menu_item)
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse{{$menu_item->id}}"
                       aria-expanded="true" aria-controls="collapse{{$menu_item->id}}">
                        <i class="fas fa-fw fa-cog"></i>
                        <span>{{ $menu_item->title }}</span>
                    </a>
                    <div id="collapse{{$menu_item->id}}" class="collapse" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            @foreach($menu_item->children as $submenu_item)
                                <a class="collapse-item" href="/alder/{{ $submenu_item->slug }}">{{ $submenu_item->title }}</a>
                            @endforeach
                        </div>
                    </div>
                </li>
